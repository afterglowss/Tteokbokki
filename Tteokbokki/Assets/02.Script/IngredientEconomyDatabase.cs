...
public static class IngredientEconomyDatabase
{
    public static readonly Dictionary<string, IngredientMetaData> Data = new()
    {
        ...
        { "계란", new IngredientMetaData { Name = "계란", SalePricePerUse = 1500, OrderAmountKg = 4, PricePerKg = 10000, GramsPerServing = 20 } },
        ...
        { "소세지", new IngredientMetaData { Name = "소세지", SalePricePerUse = 1500, OrderAmountKg = 4, PricePerKg = 8000, GramsPerServing = 20 } },
