...
namespace Yarn.Unity
{
    ...
    public sealed class CustomOptionsPresenter : DialoguePresenterBase
    {
        ...
        private OptionItem CreateNewOptionView()
        {
            ...
            var targetTransform = optionsContainer != null ? optionsContainer : (canvasGroup != null ? canvasGroup.transform : this.transform);
